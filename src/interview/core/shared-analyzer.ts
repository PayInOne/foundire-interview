...
3. 生成 1-3 个下一步追问（可直接问出口；优先基于候选人刚刚的回答，必要时结合简历验证）
...
3. Generate 1-3 follow-up questions that can be asked verbatim (short, conversational). Anchor to the candidate's last answer; optionally validate resume details.
